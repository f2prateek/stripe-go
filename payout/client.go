...
const (
	...
	InsufficientFunds    stripe.PayoutFailCode = "insufficient_funds"
	AccountClosed        stripe.PayoutFailCode = "account_closed"
	NoAccount            stripe.PayoutFailCode = "no_account"
	InvalidAccountNumber stripe.PayoutFailCode = "invalid_account_number"
	DebitNotAuth         stripe.PayoutFailCode = "debit_not_authorized"
	BankOwnerChanged     stripe.PayoutFailCode = "bank_ownership_changed"
	AccountFrozen        stripe.PayoutFailCode = "account_frozen"
	CouldNotProcess      stripe.PayoutFailCode = "could_not_process"
	BankAccountRestrict  stripe.PayoutFailCode = "bank_account_restricted"
	InvalidCurrency      stripe.PayoutFailCode = "invalid_currency"
)
