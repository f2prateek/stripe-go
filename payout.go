...
// PayoutFailCode is the list of allowed values for the payout's failure code.
...
type Payout struct {
	...
	CancellationTx *Transaction      `json:"cancellation_balance_transaction"`
	Card           *Card             `json:"card"`
	Created        int64             `json:"created"`
	Currency       Currency          `json:"currency"`
	Desc           string            `json:"description"`
	Dest           PayoutDestination `json:"destination"`
	FailCode       PayoutFailCode    `json:"failure_code"`
